...
function main()
    xc = GetDigit_n_xc.getxc(gauss_gl, MAXN, DIGIT, true)
    n = GetDigit_n_xc.getn_linear(gauss_gl, xc, MAXN, DIGIT, true)
    precision = GetDigit_n_xc.getdigit(gauss_gl, xc, n, DIGIT, true)
